	...
	*/
	function educenter_features_services_section() { 
		...
		if( !empty( $foption ) && $foption == 1 ){ ?>
			...
			<section class="ed-services layout-3">
				<div class="container">
...
if ( ! function_exists( 'educenter_calltoaction_section' ) ) :
	...
	*/
	function educenter_calltoaction_section() { 
		...
		?>
			<section class="ed-cta layout-1" <?php if(!empty( $page_id )) ?> style="background-image: url(<?php echo esc_url( $image[0] ); ?>)" <?php } ?>>
	...
	*/
	function educenter_services_section() { 
		...
		if( !empty( $services ) && $services == 1 ){ ?>
			...
			<section class="ed-services layout-2">
				<div class="container">
					<div class="ed-service-left">
						<?php
							/**
						...
						<div class="ed-col-holder clearfix">
							...
							?>
								<div class="col">
									...
									<div class="icon-holder">
										<i class="fa <?php echo esc_attr( $service->services_icon ); ?>"></i>
									</div>
	...
	*/
	function educenter_counter_section() { 
		...
		if( !empty( $counter ) && $counter == 1 ){ ?>
			...
			<section data-layout="counter" class="educenter_counter_wrap" style="background-image: url(<?php echo esc_url( get_theme_mod('educenter_counter_bg_image') ); ?>); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; background-position: center;">
								...
								?>
									...
									<div class="ed-col ed-col-three">
										<div class="ed-img-holder">
											...
											<span class="course_price"><?php echo esc_attr( $course->course_price ); ?></span>
										</div>
										<div class="ed-text-holder">
	...
	function educenter_gallery_section() { 
		...
		if( !empty( $gallery ) && $gallery == 1 ){ 
			...
			if( !empty( $allgallery ) ){ ?>
				...
				<section class="ed-gallery clearfix">
					<div class="container">
	...
	*/
	function educenter_testimonials_section() { 
		...
		if( !empty( $testimonial ) && $testimonial == 1 ){ ?>
			...
			<section class="ed-testimonials layout-2">
				<div class="container">
					<?php
						/**
						 * Section Main Title & SubTitle
